...
public class DriveControls {
  ...
  public final JoystickButton makeWheelsSideways = new JoystickButton(joystick0, 11);
  public final JoystickButton balanceRobot = new JoystickButton(joystick0, 10);
